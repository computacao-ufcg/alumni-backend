package br.edu.ufcg.computacao.alumni.core.models.orders;

//import br.edu.ufcg.computacao.alumni.core.datastore.DatabaseManager;
import br.edu.ufcg.computacao.alumni.core.models.ResourceType;
...
//    public void setOrderState(OrderState state) throws Exception {
...
//    }
    ...
    @PostLoad
    private void deserializeSystemUser() throws Exception {
        try {
    ...
    public abstract void updateFromRemote(T remoteOrder) throws Exception;
}
