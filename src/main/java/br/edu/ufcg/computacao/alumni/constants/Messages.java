...
public class Messages {
    public static final String ADD_EMPLOYER_S = "Adding employer: %s.";
    public static final Object ALL_SET = "All services have been initialized.";
    public static final String COULD_NOT_LOAD_ALUMNI_DATA = "Could not load Alumnus data.";
    public static final String COULD_NOT_LOAD_EMPLOYERS_S = "Could not load Employers data.";
